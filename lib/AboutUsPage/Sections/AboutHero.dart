    ...
    return Column(
      ...
      children: [
        ...
        ConstrainedBox(
          ...
          child: Text(
            "CropBio is a research-driven platform dedicated to crop biodiversity monitoring, agricultural science, space-enabled field data systems, and evidence-based decision-making for sustainable farming systems in the Philippines.",
            textAlign: center ? TextAlign.center : TextAlign.left,
            style: GoogleFonts.nunito(
              color: mutedText,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            "Advancing sustainable crop systems",
            style: GoogleFonts.nunito(
              color: lightText,
              fontSize: 13,
              fontWeight: FontWeight.w900,
