  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.symmetric(
        vertical: layout.isMobile ? 58 : 88,
    ...
    return Column(
      ...
      children: [
        ...
        ConstrainedBox(
          ...
          child: Text(
            "Empowering agricultural research through field data collection, remote sensing, geospatial analytics, crop biodiversity monitoring, and decision-support systems.",
            textAlign: center ? TextAlign.center : TextAlign.left,
            style: GoogleFonts.nunito(
              color: mutedText,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            "Science-based agricultural solutions",
            style: GoogleFonts.nunito(
              color: lightText,
              fontSize: 13,
              fontWeight: FontWeight.w900,
